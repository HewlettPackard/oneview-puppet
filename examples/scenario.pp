...
oneview_ethernet_network{'Ethernet Network 1':
  ensure  => 'present',
  require => Oneview_server_hardware_type['Server Hardware Type'],
  data    =>
  {
    name           => 'Puppet Ethernet Network 1',
    vlanId         => '1045',
    purpose        => 'General',
    smartLink      => true,
...
oneview_logical_interconnect_group{'Logical Interconnect Group':
  ...
  require => Oneview_ethernet_network['Ethernet Network 1'],
  data    => {
    name                => 'Puppet LIG',
    enclosureType       => 'C7000',
    type                => 'logical-interconnect-groupV3',
    internalNetworkUris => ['Puppet Ethernet Network 1'],
    interconnects       =>
    [
      {
        bay  => 1,
...
oneview_network_set{'Network Set':
  ...
  data    =>
  {
    ...
    networkUris => ['Puppet Ethernet Network 1']
  }
}
