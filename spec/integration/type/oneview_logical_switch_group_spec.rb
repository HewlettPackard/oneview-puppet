...
type_class = Puppet::Type.type(:oneview_logical_switch_group)
...
describe type_class, integration: true do
  ...
  it 'should require a data hash' do
    ...
    end.to raise_error(Puppet::ResourceError, 'Parameter data failed on Oneview_logical_switch_group[LSG]: '\
