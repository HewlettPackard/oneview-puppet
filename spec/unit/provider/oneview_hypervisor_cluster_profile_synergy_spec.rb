...
resource_type = OneviewSDK.resource_named(:Hypervisor Cluster Profile, api_version, :Synergy)
...
describe provider_class, unit: true do
  ...
  context 'given the Creation parameters' do
    ...
    it 'should be an instance of the provider oneview_hypervisor_cluster_profile' do
      expect(provider).to be_an_instance_of Puppet::Type.type(:oneview_hypervisor_cluster_profile).provider(:synergy)
    end
